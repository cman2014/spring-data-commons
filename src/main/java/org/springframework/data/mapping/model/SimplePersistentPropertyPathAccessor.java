...
public class SimplePersistentPropertyPathAccessor<T> implements PersistentPropertyPathAccessor<T> {
	...
	public void setProperty(PersistentPropertyPath<? extends PersistentProperty<?>> path, @Nullable Object value) {
		...
		if (parentProperty.isCollectionLike()) {
			...
			Map<Object, Object> source = (Map<Object, Object>) getTypedProperty(parentProperty, Map.class);
